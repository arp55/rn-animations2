import Animated, { cond, eq, add, sqrt, or, neq, pow, sub, and, greaterThan, modulo, greaterOrEq, lessOrEq, multiply, lessThan, divide, abs, cos, sin } from 'react-native-reanimated';

type Value = typeof Animated.Value;
