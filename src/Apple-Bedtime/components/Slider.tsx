...
import Animated, { add, concat, cond, lessThan, multiply, sub, Value } from 'react-native-reanimated'
...
export default function Slider() {
    ...
    const delta = sub(cond(lessThan(end, start), add(Math.PI * 2, end), end), start)
    ...
    return (
        <View style={styles.container}>
                ...
                <Svg width={size} height={size}>
                    <Defs>
                        <LinearGradient id="grad" x1="0" y1="0" x2="170" y2="0">
                            ...
                            <Stop offset="0" stopColor="#f5d346" />
                        </LinearGradient>
                    </Defs>
                    <Circle
                        stroke="rgb(50,50,50)"
            ...
            <Svg width={size - strokeWidth * 2} height={size - strokeWidth * 2} viewBox="0 0 88 88">
